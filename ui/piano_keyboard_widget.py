...
from PyQt5.QtWidgets import (
    ...
    QPushButton, QButtonGroup, QSizePolicy, QGridLayout
)
...
class PianoKeyboardWidget(QWidget):
    ...
    def init_ui(self):
        ...
        # 白键120px + 黑键50px + 间距 = 约180px
        self.keys_container.setMinimumHeight(180)  # 确保黑白键完全显示
        self.keys_container.setMaximumHeight(180)  # 限制最大高度
        ...
        for col, note_name in enumerate(white_notes):
            ...
            btn.setCheckable(True)
            btn.setMinimumHeight(120)  # 白键高度
            btn.setMaximumHeight(120)  # 限制最大高度
        ...
        # 确保wrapper不会裁剪内容
        container_wrapper.setMinimumHeight(180)
        container_wrapper.setMaximumHeight(180)
